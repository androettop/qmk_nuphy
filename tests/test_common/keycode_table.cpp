...
std::map<uint16_t, std::string> KEYCODE_ID_TABLE = {
    ...
    {QK_MAGIC_PABLO_TEST_MODE_ON, "QK_MAGIC_PABLO_TEST_MODE_ON"},
    {QK_MAGIC_PABLO_TEST_MODE_OFF, "QK_MAGIC_PABLO_TEST_MODE_OFF"},
    {QK_MAGIC_PABLO_TEST_MODE_TOGGLE, "QK_MAGIC_PABLO_TEST_MODE_TOGGLE"},
