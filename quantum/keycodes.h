...
// Keycodes
    ...
    QK_MAGIC_PABLO_TEST_MODE_ON = 0x7023,
    QK_MAGIC_PABLO_TEST_MODE_OFF = 0x7024,
    QK_MAGIC_PABLO_TEST_MODE_TOGGLE = 0x7025,
    QK_MAGIC_LAST = 0x7099,
    QK_MIDI_ON = 0x7100,
    QK_MIDI_OFF = 0x7101,
...
// Alias
    ...
    PB_ON      = QK_MAGIC_PABLO_TEST_MODE_ON,
    PB_OFF     = QK_MAGIC_PABLO_TEST_MODE_OFF,
    PB_TOGG    = QK_MAGIC_PABLO_TEST_MODE_TOGGLE,
...
#define IS_MAGIC_KEYCODE(code) ((code) >= QK_MAGIC_SWAP_CONTROL_CAPS_LOCK && (code) <= QK_MAGIC_LAST)
